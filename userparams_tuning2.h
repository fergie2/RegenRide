...
#define MIN_VBUS        (unsigned int) (18 / TOP_VBUS  * 65535) // in Volts
...
#define MAX_CURRENT              (int) (15 / IPEAK     * 32767) // In Amp, peak current, currently 55A
...
#define PHASEIND                0.0005  // in Henry
#define PHASE_ZERO_D            0     // initial phase for Hall angle interpolator in "Forward Mode"
#define PHASE_ZERO_R            0      // 29537 initial phase for Hall angle interpolator in "Reverse Mode"
...
#define MAX_TORQUE_CURRENT      7        // in Amps, this is the peak current
#define MAX_TORQUE_CURRENT_LIMP 20        // in Amps, this is the peak current
#define MIN_TORQUE_CURRENT      1         // in Amps, this is the peak current
...
#define MAX_SPEED_RPM           2000       // in RPM, used only in closed loop speed control
#define MIN_SPEED_RPM           20        // in RPM, used only in closed loop speed control
...
#define MAX_PHASE_ERROR     3500            //182 units per degree, 15 degrees
#define MIN_PHASE_ERROR     -3500           //182 units per degree, -15 degrees
...
#define SMCGAIN			0.55    // Sliding Mode Controller Gain (0.0 to 0.9999)
...
#define     DKP        Q15(0.25)
#define     DKI        Q15(0.006)
#define     DKC        Q15(1)
#define     DOUTMAX    Q15(1)

//******** Q Control Loop Coefficients *******
#define     QKP        Q15(0.25)
#define     QKI        Q15(0.006)
#define     QKC        Q15(1)
